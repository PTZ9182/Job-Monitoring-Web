        ...
        <section class="bg-Neutral/13 h-auto w-full flex flex-col lg:w-4/5">
            ...
            <div class="mx-10 mt-5 lg:mx-20 lg:mt-14 ">
                ...
                <div class="flex flex-col items-center mt-6 lg:flex-row lg:justify-between">
                    <div class=" w-full mt-5 lg:flex lg:items-center lg:justify-center lg:w-1/2 lg:mt-0">
                        <a href="{{ Route("pengaturan.edit.profil.show") }}" class="bg-Neutral/01 hover:bg-Neutral/15 flex w-full  justify-center px-1 py-4 rounded-3xl drop-shadow-lg shadow-inner lg:w-1/2">
                            <span class="font-medium text-ms ml-4">Edit Profil</span>
                         </a>
                    </div>
                    
                    <div class="w-full mt-5 lg:flex lg:items-center lg:justify-center lg:w-1/2 lg:mt-0">
                          <a href="{{ Route("pengaturan.ganti.password.show") }}" class="bg-Neutral/15  flex w-full justify-center px-1 py-4 rounded-3xl drop-shadow-lg shadow-inner lg:w-1/2">
            ...
            <div class="my-10 lg:flex lg:flex-col lg:items-center">
                <div class=" p-10 mx-5 bg-white rounded-3xl drop-shadow-lg shadow-inner lg:w-1/2 ">
                    ...
                    {{-- form ganti password --}} 
                    <form action="{{ route('pengaturan.ganti.password.submit',Auth::user()->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="password" class="font-semibold text-sm text-Neutral/06">*Password Lama</label>
                            <input type="password" id="password" name="password" class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-3xl outline-none leading-tight py-3 px-5" required>
                        </div>
                        <div class="mb-3">
                            <label for="passwordbaru1" class="font-semibold text-sm text-Neutral/06">*Password Baru</label>
                            <input type="password" id="passwordbaru1" name="passwordbaru1" class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-3xl outline-none leading-tight py-3 px-5" required>
                        </div>
                        <div class="mb-10">
                            <label for="passwordbaru2" class="font-semibold text-sm text-Neutral/06">*Password Baru</label>
                            <input type="password" id="passwordbaru2" name="passwordbaru2" class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-3xl outline-none leading-tight py-3 px-5" required>
                        </div>
