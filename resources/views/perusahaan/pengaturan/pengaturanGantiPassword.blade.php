            ...
            <div class="mx-10 mt-5 lg:mx-20 lg:mt-14 ">
                ...
                <div class="flex flex-col items-center mt-6 lg:flex-row lg:justify-between">
                    <div class=" w-full mt-5 lg:flex lg:items-center lg:justify-center lg:w-1/2 lg:mt-0">
                        <a href="{{ Route("pengaturan.edit.profil.show") }}" class="bg-Neutral/01 hover:bg-Neutral/15 flex w-full  justify-center px-1 py-4 rounded-lg drop-shadow-lg shadow-inner lg:w-1/2">
                            <span class="font-medium text-sm ml-4">Edit Profil</span>
                         </a>
                    </div>
                    
                    <div class="w-full mt-5 lg:flex lg:items-center lg:justify-center lg:w-1/2 lg:mt-0">
                          <a href="{{ Route("pengaturan.ganti.password.show") }}" class="bg-Neutral/15  flex w-full justify-center px-1 py-4 rounded-lg drop-shadow-lg shadow-inner lg:w-1/2">
