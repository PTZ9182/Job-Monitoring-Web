    ...
    <div class="flex flex-row ">
        ...
        <section class="bg-Neutral/13 h-auto w-full flex flex-col lg:w-4/5">
            ...
            <div class="mt-5 lg:mt-14 ">
                <h1 class="font-bold text-3xl text-center">Tambah Karyawan</h1>
            </div>
            ...
            <div class="my-10 lg:flex lg:flex-col lg:items-center">
                <div class=" p-10 mx-5 bg-white rounded-3xl drop-shadow-lg shadow-inner lg:w-1/2 ">
                    ...
                    <form action="{{ route('karyawan.tambah.submit') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="nama" class="block font-semibold text-sm text-Neutral/06">*Nama Karyawan</label>
                            <input type="text" id="nama" name="nama" class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-3xl outline-none leading-tight py-3 px-2" required>
                        </div>
                        <div class="mb-4">
                            <label for="tanggal_lahir" class="block font-semibold text-sm text-Neutral/06">*Tanggal Lahir Karyawan</label>
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-3xl outline-none leading-tight py-3 px-2" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="alamat" name="alamat" class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-3xl outline-none leading-tight py-3 px-2" required>
                        </div>
                        <div class="mb-4">
                            <label for="phone" class="block font-semibold text-sm text-Neutral/06">*No.Handphone Karyawan</label>
                            <input type="tel" id="phone" name="phone" class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-3xl outline-none leading-tight py-3 px-2" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" id="email" name="email" placeholder="" class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-3xl outline-none leading-tight py-3 px-2" required>
                        </div>
                        <div class="mb-10">
                            <label for="password" class="font-semibold text-sm text-Neutral/06">*Password</label>
                            <input type="password" id="password" name="password" placeholder="" class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-3xl outline-none leading-tight py-3 px-2" required>
                        </div>
