                ...
                <div class=" p-10 mx-5 bg-white rounded-3xl drop-shadow-lg shadow-inner lg:w-1/2 ">
                    ...
                    <form action="{{ route('karyawan.tambah.submit') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nama" name="nama" required class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-md outline-none leading-tight py-3 px-2">
                        </div>
                        <div class="mb-4">
                            <label for="tanggal_lahir" class="block font-semibold text-sm text-Neutral/06">*Tanggal Lahir Karyawan</label>
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir" required class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-md outline-none leading-tight py-3 px-2">
                        </div>
                        <div class="mb-4">
                            <label for="jenis_kelamin" class="block font-semibold text-sm text-Neutral/06">*Jenis Kelamin Karyawan</label>
                            <select id="jenis_kelamin" name="jenis_kelamin" required class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-md outline-none leading-tight py-3 px-2">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="alamat" name="alamat" required class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-md outline-none leading-tight py-3 px-2">
                        </div>
                        <div class="mb-4">
                            <label for="phone" class="block font-semibold text-sm text-Neutral/06">*No.Handphone Karyawan</label>
                            <input type="tel" id="phone" name="phone" required class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-md outline-none leading-tight py-3 px-2">
                        </div>
                        <div class="mb-4">
                            <label for="divisi" class="block font-semibold text-sm text-Neutral/06">*Divisi Karyawan</label>
                            <select id="divisi" name="divisi" required class="w-full font-normal text-sm text-Neutral/08 border border-black rounded-md outline-none leading-tight py-3 px-2">
