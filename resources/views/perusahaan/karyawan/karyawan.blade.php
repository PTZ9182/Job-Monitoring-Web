...
<body>
    <div class="flex flex-row ">
        ...
        <section class="bg-Neutral/13 h-auto w-full flex flex-col lg:w-4/5">
                    ...
                    <div class="bg-Neutral/01 flex flex-row w-full justify-between px-5 py-5 rounded-lg drop-shadow-lg shadow-inner lg:w-1/2 lg:mr-10">
                        ...
                        <div>
                            <a href="{{ Route("karyawan.tambah.show") }}" class="flex items-center"> 
                                <button class="font-medium text-sm text-black-500 bg-Neutral/05 hover:bg-stone-300 rounded-md outline-none leading-tight py-3 px-5 lg:px-12" type="button">Tambah Karyawan</button>
                            </a>
                        </div>
                    ...
                    <div class="w-full mt-5 lg:items-center lg:justify-end lg:w-1/2 lg:mt-0">
                        <form>
                            <div class="rounded-md drop-shadow-lg shadow-inner flex justify-between">
                              <input class="w-full rounded-l-md text-ms px-1 py-2 lg:px-2 lg:py-3 " type="search" id="mySearch" name="mySearch" placeholder="Cari Nama Karyawan" />
            ...
            <div class="bg-white mx-10 mt-5 rounded-md drop-shadow-lg shadow-inner lg:mx-20 lg:mt-10">
                    ...
                    <table>
                        ...
                        @foreach ($dataId as $dataId)
                            ...
                            <tr class="border-2">
                                ...
                                <td class="font-normal text-sm py-3 ">{{ $dataId->idDivisi}}</td>
                    ...
                    <div class="bg-white w-auto p-10 rounded shadow-md">
                        <div class="flex flex-col p-4 md:p-5 text-center items-center">
                            ...
                            <form id="form-hapus-karyawan" method="post">
                                @csrf
                                <button id="hapusKaryawanButton" data-modal-hide="popup-modal" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">Hapus</button>
                                <button id="tidakHapusKaryawanButton" data-modal-hide="popup-modal" type="button" class="py-2.5 px-5 mt-3 lg:mt-0 lg:ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Tidak</button>
                            </form>
