    ...
    <div class="flex flex-row ">
        ...
        <section class="bg-Neutral/13 h-auto w-full flex flex-col lg:w-4/5">
            ...
            <div class="mx-10 mt-5 lg:mx-20 lg:mt-14 ">
                ...
                <div class="mx-20 flex flex-col items-center mt-10 lg:flex-row lg:justify-between">
                    <div class=" flex flex-row">
                        <a href="{{ route('presensi.jadwal.show') }}">
                            <button class="w-auto px-10 font-medium text-ms  bg-Neutral/15 drop-shadow-md rounded-3xl outline-none leading-tight py-5" type="button">Pengaturan Jadwal Presensi</button>
                        </a>
                ...
                {{-- content jadwal presensi --}}
                <div class="bg-white mb-20 mt-5 rounded-3xl drop-shadow-lg shadow-inner lg:mx-20 lg:mt-10 py-5 px-5 ">
                    <div class="flex flex-col ">

                        <div class=" flex items-center justify-center">
                            <h1 class="font-medium text-2xl text-end mb-10 mt-10 mx-20">Jadwal Presensi</h1>
                        </div>

                        <div class="shadow-inner rounded-3xl mb-10 mx-10">
                            
                            {{-- form jadwal presensi --}}
                            <form action="{{ route('presensi.jadwal.edit.submit',Auth::user()->id)}}" method="POST">
                                @csrf

                                <div class=" flex flex-row items-center px-2 py-2 font-medium justify-between">
                                    <div class="flex items-center">

                                        @if( $seninKerja == 'kerja' )
                                        <div class="">
                                            <svg height="50" width="50" xmlns="http://www.w3.org/2000/svg">
                                                <circle r="10" cx="25" cy="25" fill="green" />
                                              </svg>
                                        </div>
                                        @else
                                        <div class="">
                                        ...
                                        <label for="seninKerja">Senin</label>
                                        <select id="seninKerja" name="seninKerja" class="font-normal text-sm border rounded-3xl px-10 py-2 mx-10">
                                            <option value="kerja" <?php if ($seninKerja == 'kerja') echo 'selected' ?> class="bg-green-700">Kerja</option>
                                            <option value="libur" <?php if ($seninKerja == 'libur') echo 'selected' ?> class="bg-red-700">Libur</option>
                                        </select>

                                    </div>
                                    <div class="items-end ml-10">
                                        <label for="seninMasuk">Masuk :</label>
                                        <input type="time" id="seninMasuk" name="seninMasuk" value="{{ $seninMasuk }}" class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                        <label for="seninKeluar">Selesai </label>
                                        <input type="time" id="seninKeluar" name="seninKeluar" value="{{ $seninKeluar }}" class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                    </div>  
                                </div>
                                ...
                                <div class=" flex flex-row items-center px-2 py-2 font-medium justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <label for="selasaKerja">Selasa</label>
                                        <select id="selasaKerja" name="selasaKerja" class="font-normal text-sm border rounded-3xl px-10 py-2 mx-10">
                                            <option value="kerja" <?php if ($selasaKerja == 'kerja') echo 'selected' ?> class="bg-green-700">Kerja</option>
                                            <option value="libur" <?php if ($selasaKerja == 'libur') echo 'selected' ?> class="bg-red-700">Libur</option>
                                        </select>

                                    </div>
                                    <div class="items-end">
                                        <label for="selasaMasuk">Masuk :</label>
                                        <input type="time" id="selasaMasuk" name="selasaMasuk" value="{{ $selasaMasuk }}" class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                        <label for="selasaKeluar">Selesai </label>
                                        <input type="time" id="selasaKeluar" name="selasaKeluar" value="{{ $selasaKeluar }}" class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                    </div>  
                                </div>
                                ...
                                <div class=" flex flex-row items-center px-2 py-2 font-medium justify-between">
                                    <div class="flex items-center">
                                        ...
                                        @endif
                                        <label for="rabuKerja">Rabu</label>
                                        <select id="rabuKerja" name="rabuKerja" class="font-normal text-sm border rounded-3xl px-10 py-2 mx-10">
                                            <option value="kerja" <?php if ($rabuKerja == 'kerja') echo 'selected' ?> class="bg-green-700">Kerja</option>
                                            <option value="libur" <?php if ($rabuKerja == 'libur') echo 'selected' ?> class="bg-red-700">Libur</option>
                                        </select>

                                    </div>
                                    <div class="items-end">
                                        <label for="rabuMasuk">Masuk :</label>
                                        <input type="time" id="rabuMasuk" name="rabuMasuk" value="{{ $rabuMasuk }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                        <label for="rabuKeluar">Selesai </label>
                                        <input type="time" id="rabuKeluar" name="rabuKeluar" value="{{ $rabuKeluar }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                    </div>  
                                </div>
                                ...
                                <div class=" flex flex-row items-center px-2 py-2 font-medium justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <label for="kamisKerja">Kamis</label>
                                        <select id="kamisKerja" name="kamisKerja" class="font-normal text-sm border rounded-3xl px-10 py-2 mx-10">
                                            <option value="kerja" <?php if ($kamisKerja == 'kerja') echo 'selected' ?> class="bg-green-700">Kerja</option>
                                            <option value="libur" <?php if ($kamisKerja == 'libur') echo 'selected' ?> class="bg-red-700">Libur</option>
                                        </select>

                                    </div>
                                    <div class="items-end">
                                        <label for="kamisMasuk">Masuk :</label>
                                        <input type="time" id="kamisMasuk" name="kamisMasuk" value="{{ $kamisMasuk }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                        <label for="kamisKeluar">Selesai </label>
                                        <input type="time" id="kamisKeluar" name="kamisKeluar" value="{{ $kamisKeluar }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                    </div>  
                                </div>
                                ...
                                <div class=" flex flex-row items-center px-2 py-2 font-medium justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <label for="jumatKerja">Jumat</label>
                                        <select id="jumatKerja" name="jumatKerja" class="font-normal text-sm border rounded-3xl px-10 py-2 mx-10">
                                            <option value="kerja" <?php if ($jumatKerja == 'kerja') echo 'selected' ?> class="bg-green-700">Kerja</option>
                                            <option value="libur" <?php if ($jumatKerja == 'libur') echo 'selected' ?> class="bg-red-700">Libur</option>
                                        </select>

                                    </div>
                                    <div class="items-end">
                                        <label for="jumatMasuk">Masuk :</label>
                                        <input type="time" id="jumatMasuk" name="jumatMasuk" value="{{ $jumatMasuk }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                        <label for="jumatKeluar">Selesai </label>
                                        <input type="time" id="jumatKeluar" name="jumatKeluar" value="{{ $jumatKeluar }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                    </div>  
                                </div>
                                ...
                                <div class=" flex flex-row items-center px-2 py-2 font-medium justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <label for="sabtuKerja">Sabtu</label>
                                        <select id="sabtuKerja" name="sabtuKerja" class="font-normal text-sm border rounded-3xl px-10 py-2 mx-10">
                                            <option value="kerja" <?php if ($sabtuKerja == 'kerja') echo 'selected' ?> class="bg-green-700">Kerja</option>
                                            <option value="libur" <?php if ($sabtuKerja == 'libur') echo 'selected' ?> class="bg-red-700">Libur</option>
                                        </select>

                                    </div>
                                    <div class="items-end">
                                        <label for="sabtuMasuk">Masuk :</label>
                                        <input type="time" id="sabtuMasuk" name="sabtuMasuk" value="{{ $sabtuMasuk }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                        <label for="sabtuKeluar">Selesai </label>
                                        <input type="time" id="sabtuKeluar" name="sabtuKeluar" value="{{ $sabtuKeluar }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                    </div>  
                                </div>
                                ...
                                <div class=" flex flex-row items-center px-2 py-2 font-medium justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <label for="mingguKerja">Minggu</label>
                                        <select id="mingguKerja" name="mingguKerja" class="font-normal text-sm border rounded-3xl px-10 py-2 mx-10">
                                            <option value="kerja" <?php if ($mingguKerja == 'kerja') echo 'selected' ?> class="bg-green-700">Kerja</option>
                                            <option value="libur" <?php if ($mingguKerja == 'libur') echo 'selected' ?> class="bg-red-700">Libur</option>
                                        </select>

                                    </div>
                                    <div class="items-end">
                                        <label for="mingguMasuk">Masuk :</label>
                                        <input type="time" id="mingguMasuk" name="mingguMasuk" value="{{ $mingguMasuk }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                        <label for="mingguKeluar">Selesai </label>
                                        <input type="time" id="mingguKeluar" name="mingguKeluar" value="{{ $mingguKeluar }}"  class="font-normal text-sm border rounded-3xl px-4 py-2 mx-5">
                                    </div>  
                                </div>
